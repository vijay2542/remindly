...
class _SpeechDialogState extends ConsumerState<SpeechDialog> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ref.read(voiceStateNotifierProvider.notifier).startListening(localeId: _selectedLanguage.sttLocaleId);
    });
  }
        ...
        child: Column(
          ...
          children: [
                      ...
                      child: DropdownButton<AppLanguage>(
                        ...
                        onChanged: (newLang) async {
                          if (newLang != null && newLang != _selectedLanguage) {
                            ...
                            ref.read(voiceStateNotifierProvider.notifier).startListening(localeId: newLang.sttLocaleId);
                          }
                        },
            ...
            if (voiceState.status == VoiceStatus.listening) ...[
              ...
              Text(
                'Speak clearly into microphone (${_selectedLanguage.englishName})...',
